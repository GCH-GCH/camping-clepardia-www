...
export const sitePages: Record<PageSlug, SitePage> = {
  ...
  atrakcje: {
    ...
    seoDescription: 'Camping Clepardia jako baza wypadowa do zwiedzania Krakowa, Wieliczki, Ojcowa, Energylandii i Małopolski.',
    highlights: [
  ...
  kontakt: {
    ...
    seoDescription: 'Kontakt i zapytania rezerwacyjne Camping Clepardia w Krakowie.',
    highlights: [
  ...
  galeria: {
    ...
    seoDescription: 'Galeria Camping Clepardia: zdjęcia campingu, domków, sanitariatów, dojazdu, Krakowa i udogodnień dla gości.',
    highlights: [
  ...
  'dla-kamperow': {
    ...
    seoDescription: 'Camping Clepardia dla kamperów, vanów, przyczep i aut z namiotem dachowym: postój w Krakowie, prąd, zaplecze i tramwaj do centrum.',
    highlights: [
  ...
  'dla-rodzin': {
    ...
    seoDescription: 'Camping Clepardia dla rodzin z dziećmi: domki, camping, zielona baza w Krakowie, dojazd tramwajem do centrum i atrakcje Małopolski.',
    highlights: [
