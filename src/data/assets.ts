...
export const siteAssets = {
  ...
  camping: {
    ...
    camperArea: '/images/sections/camper-pitches-concrete-slabs.webp',
    tents: '/images/sections/campers-under-trees.webp',
    electricity: '/images/sections/camping-kitchen-main.webp',
    road: '/images/sections/campground-road-main-field.webp',
    canopy: '/images/sections/camping-green-canopy.webp',
  },
  bungalows: {
    exterior: '/images/sections/bungalows-main.webp',
    room: '/images/sections/domek-3os-bedroom-main.webp',
    bungalow3: '/images/sections/bungalows-path.webp',
    bungalow4: '/images/sections/bungalows-row.webp',
    rowCampingView: '/images/sections/bungalows-row-camping-view.webp',
    bathroom: '/images/sections/bungalow-bathroom.webp',
    domek4Living: '/images/sections/domek-4os-living-dining.webp',
  },
  sanitary: {
    building: '/images/sections/sanitary-facilities-main.webp',
  ...
  transport: {
    ...
    ticketMachine: '/images/attractions/tram-ticket-machine.webp',
    googleMaps: '/images/sections/tram-stop-near-camping.webp',
    jakdojade: '/images/sections/tram-stop-near-camping.webp',
  },
  family: {
    playground: '/images/sections/family-playground-main.webp',
    playgroundWide: '/images/sections/family-playground.webp',
  },
  reception: {
    main: '/images/sections/reception-main.webp',
  },
  aerial: {
    overview: '/images/sections/drone-overview-camping.webp',
  ...
  gallery: {
    ...
    campingCamperArea: '/images/sections/camper-pitches-concrete-slabs.webp',
    campingTents: '/images/sections/campers-under-trees.webp',
    campingElectricity: '/images/sections/camping-kitchen-main.webp',
    bungalowExterior: '/images/sections/bungalows-main.webp',
    bungalowRoom: '/images/sections/domek-3os-bedroom-main.webp',
    bungalow3: '/images/sections/bungalows-path.webp',
    bungalow4: '/images/sections/bungalows-row.webp',
    sanitaryBuilding: '/images/sections/sanitary-facilities-main.webp',
    showers: '/images/sections/sanitary-facilities.webp',
    kitchen: '/images/sections/camping-kitchen-main.webp',
    laundry: '/images/sections/camping-laundry-room.webp',
    tramToCenter: '/images/sections/tram-stop-near-camping.webp',
  ...
  sections: {
    camping: {
      ...
      tents: '/images/sections/campers-under-trees.webp',
      electricity: '/images/sections/camping-kitchen-main.webp',
      camperSlabs: '/images/sections/camper-pitches-concrete-slabs.webp',
      road: '/images/sections/campground-road-main-field.webp',
    },
    bungalows: {
