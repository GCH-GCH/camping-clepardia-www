...
export const pl = {
  ...
  footer: {
    description:
      'Camping w Krakowie blisko centrum miasta. Strona przygotowana pod przyszłe rezerwacje online i integrację z CC SYSTEM.',
    languages: 'Wersje językowe',
    quickLinks: 'Szybkie linki',
    contact: 'Kontakt',
    contactPlace: 'Camping Clepardia<br />Kraków, Polska',
