...
const texts: Record<CorePublicLanguage, CoreText> = {
  fr: {
    ...
    heroBadge: 'Camping premium à Cracovie',
  ...
  es: {
    ...
    heroBadge: 'Camping premium en Cracovia', heroSubtitle: 'Camping en Cracovia cerca del centro', heroCopy: 'Una base verde para autocaravanas, caravanas, tiendas y bungalows. Descansa tranquilo y llega al casco antiguo en tranvía.', heroPrimary: 'Enviar consulta', heroSecondary: 'Ver precios', heroBadges: ['Cerca del centro', 'Camping + bungalows', 'Tranvía al centro', 'Mister Camping 2024 & 2025'],
  ...
  nl: {
    ...
    heroBadge: 'Premium camping in Krakau', heroSubtitle: 'Camping in Krakau dicht bij het centrum', heroCopy: 'Een groene basis voor campers, caravans, tenten en bungalows. Rust uit en ga met de tram naar de Oude Stad.', heroPrimary: 'Aanvraag sturen', heroSecondary: 'Bekijk prijzen', heroBadges: ['Dicht bij centrum', 'Camping + bungalows', 'Tram naar centrum', 'Mister Camping 2024 & 2025'],
  ...
  sv: {
    ...
    heroBadge: 'Premiumcamping i Kraków', heroSubtitle: 'Camping i Kraków nära centrum', heroCopy: 'En grön bas för husbilar, husvagnar, tält och bungalower. Vila lugnt och ta spårvagnen till Gamla stan.', heroPrimary: 'Skicka förfrågan', heroSecondary: 'Se priser', heroBadges: ['Nära centrum', 'Camping + bungalower', 'Spårvagn till centrum', 'Mister Camping 2024 & 2025'],
