...
export const en = {
  ...
  footer: {
    description:
      'Camping Clepardia — campsite and bungalows in Kraków close to the city centre.',
  ...
  chat: {
    ...
    answers: {
      ...
      bungalows:
        'Bungalows have separate availability. 2-person: 200/220 PLN, 3-person from 250 PLN, 4-person: 400/450 PLN depending on season.',
      dog:
  ...
  form: {
    ...
    homeMiniNote: 'This is a quick date selector. You can send the full enquiry on the contact page.',
    loading: 'Sending...',
